...
this["wp"]["blocks"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 147: /***/ function (
      ...
      /* harmony import */ var _babel_runtime_helpers_esm_iterableToArray__WEBPACK_IMPORTED_MODULE_1__ =
      ...
      function _toArray(arr) {
        return (
          ...
          Object(
            _babel_runtime_helpers_esm_iterableToArray__WEBPACK_IMPORTED_MODULE_1__[
              /* default */ "a"
            ]
          )(arr) ||
          Object(
    ...
    */
    ...
    /***/ 444: /***/ function (
      ...
      __webpack_require__.d(
        ...
        "getBlockFromExample",
        function () {
          return /* reexport */ factory_getBlockFromExample;
        }
      );
      ...
      __webpack_require__.d(
        ...
        "getBlockContent",
        function () {
          return /* reexport */ getBlockContent;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
      ...
      __webpack_require__.d(
        ...
        "registerBlockStyle",
        function () {
          return /* reexport */ registration_registerBlockStyle;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        ...
        function () {
          return /* reexport */ registration_unregisterBlockStyle;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        ...
        function () {
          return /* reexport */ registration_registerBlockVariation;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        ...
        function () {
          return /* reexport */ registration_unregisterBlockVariation;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        ...
        switch (action.type) {
          case "ADD_BLOCK_COLLECTION":
            return _objectSpread(
              _objectSpread({}, state),
              {},
              Object(defineProperty["a" /* default */])({}, action.namespace, {
                title: action.title,
                icon: action.icon,
              })
            );
        ...
        function (state) {
          return Object.values(state.blockTypes).map(function (blockType) {
            return selectors_objectSpread(
              selectors_objectSpread({}, blockType),
              {},
              {
      ...
      var selectors_getBlockSupport = function getBlockSupport(
        ...
        return Object(external_lodash_["get"])(
          blockType,
          ["supports"].concat(
            Object(toConsumableArray["a" /* default */])(feature.split("."))
          ),
          defaultSupports
        );
      };
      ...
      var selectors_hasChildBlocksWithInserterSupport =
        function hasChildBlocksWithInserterSupport(state, blockName) {
      ...
      function getBlockLabel(blockType, attributes) {
        ...
        if ("core/template-part" === blockType.name && attributes.slug) {
          var entity = Object(external_wp_data_["select"])(
            "core"
          ).getEntityRecord(
            "postType",
            "wp_template_part",
          ...
          if (entity) {
            ...
            return Object(external_lodash_["startCase"])(
              ((_entity$title = entity.title) === null ||
              _entity$title === void 0
                ? void 0
                : _entity$title.rendered) || entity.slug
            );
          }
        }
      ...
      function sanitizeBlockAttributes(name, attributes) {
        ...
        return Object(external_lodash_["reduce"])(
          blockType.attributes,
          function (accumulator, schema, key) {
      ...
      function unstable__bootstrapServerSideBlockDefinitions(definitions) {
        for (
          var _i = 0, _Object$keys = Object.keys(definitions);
      ...
      function registerBlockType(name, settings) {
        ...
        if (settings.deprecated) {
          settings.deprecated = settings.deprecated.map(function (deprecation) {
            return Object(external_lodash_["pick"])(
      ...
      function unregisterBlockType(name) {
        var oldBlock = Object(external_wp_data_["select"])(store).getBlockType(
          name
        );
      ...
      var registration_hasChildBlocksWithInserterSupport =
      ...
      var registration_getBlockVariations = function getBlockVariations(
        blockName,
        scope
      ) {
      ...
      var registration_registerBlockVariation = function registerBlockVariation(
        blockName,
        variation
      ) {
      ...
      var registration_unregisterBlockVariation =
      ...
      function createBlocksFromInnerBlocksTemplate() {
        var innerBlocksOrTemplate =
          arguments.length > 0 && arguments[0] !== undefined
            ? arguments[0]
            : [];
        return innerBlocksOrTemplate.map(function (innerBlock) {
          var innerBlockTemplate = Array.isArray(innerBlock)
            ? innerBlock
            : [innerBlock.name, innerBlock.attributes, innerBlock.innerBlocks];

          var _innerBlockTemplate = Object(slicedToArray["a" /* default */])(
              innerBlockTemplate,
              3
            ),
            ...
            innerBlocks =
              _innerBlockTemplate$ === void 0 ? [] : _innerBlockTemplate$;
      ...
      function __experimentalCloneSanitizedBlock(block) {
        ...
        var sanitizedAttributes = sanitizeBlockAttributes(
          block.name,
          factory_objectSpread(
            factory_objectSpread({}, block.attributes),
            mergeAttributes
          )
        );
        return factory_objectSpread(
          factory_objectSpread({}, block),
          {},
          {
            clientId: clientId,
            attributes: sanitizedAttributes,
      ...
      function cloneBlock(block) {
        ...
        return factory_objectSpread(
          ...
          {
            clientId: clientId,
            attributes: factory_objectSpread(
              factory_objectSpread({}, block.attributes),
              mergeAttributes
            ),
            innerBlocks:
      ...
      var factory_isPossibleTransformForSource =
        function isPossibleTransformForSource(transform, direction, blocks) {
          ...
          if (
            !isMultiBlock &&
            factory_isContainerGroupBlock(sourceBlock.name) &&
            factory_isContainerGroupBlock(transform.blockName)
          ) {
            return false;
      ...
      var factory_getBlockTypesForPossibleFromTransforms =
        function getBlockTypesForPossibleFromTransforms(blocks) {
          if (Object(external_lodash_["isEmpty"])(blocks)) {
            return [];
          }
      ...
      var factory_getBlockTypesForPossibleToTransforms =
        function getBlockTypesForPossibleToTransforms(blocks) {
          if (Object(external_lodash_["isEmpty"])(blocks)) {
            return [];
          }
          ...
          var possibleTransforms = Object(external_lodash_["filter"])(
            ...
            function (transform) {
              return (
                transform &&
                factory_isPossibleTransformForSource(transform, "to", blocks)
              );
            }
      ...
      function getPossibleBlockTransformations(blocks) {
        ...
        var blockTypesForFromTransforms =
          factory_getBlockTypesForPossibleFromTransforms(blocks);
        var blockTypesForToTransforms =
          factory_getBlockTypesForPossibleToTransforms(blocks);
      ...
      function getBlockTransforms(direction, blockTypeOrName) {
        ...
        return transforms[direction].map(function (transform) {
          return factory_objectSpread(
            factory_objectSpread({}, transform),
            {},
            {
              blockName: blockName,
            }
      ...
      function switchToBlockType(blocks, name) {
        ...
        return transformationResults.map(function (result, index) {
          var transformedBlock = factory_objectSpread(
            factory_objectSpread({}, result),
            {},
            {
      ...
      var factory_getBlockFromExample = function getBlockFromExample(
        name,
        example
      ) {
        return createBlock(
      ...
      var block_content_provider_BlockContentProvider =
        function BlockContentProvider(_ref) {
      ...
      /* harmony default export */ var block_content_provider =
        block_content_provider_BlockContentProvider;
      ...
      function getSaveElement(blockTypeOrName, attributes) {
        ...
        if (
           ...
           * @param {Object}  attributes Block attributes.
           */
          var props = Object(external_wp_hooks_["applyFilters"])(
            "blocks.getSaveContent.extraProps",
            serializer_objectSpread({}, element.props),
            blockType,
            attributes
          );
      ...
      function getCommentAttributes(blockType, attributes) {
        return Object(external_lodash_["reduce"])(
          blockType.attributes,
          function (accumulator, attributeSchema, key) {
      ...
      function serializeBlock(block) {
        var _ref =
          ...
          isInnerBlocks =
            _ref$isInnerBlocks === void 0 ? false : _ref$isInnerBlocks;
      ...
      function isEqualTagAttributePairs(actual, expected) {
        ...
        for (var _i = 0; _i < actual.length; _i++) {
          var _actual$_i = Object(slicedToArray["a" /* default */])(
              actual[_i],
              2
            ),
            name = _actual$_i[0],
      ...
      function isValidBlockContent(
        ...
        var _getBlockContentValid = getBlockContentValidationResult(
            blockTypeOrName,
            attributes,
            originalBlockContent,
            createLogger()
      ...
      function fromDOM(domNode) {
        ...
        return {
          ...
          props: node_objectSpread(
            node_objectSpread({}, getNamedNodeMapAsObject(domNode.attributes)),
            {},
            {
            ...
            block = parser_objectSpread(
              ...
              {},
              {
                validationIssues: [].concat(
                  ...
                  Object(toConsumableArray["a" /* default */])(validationIssues)
                ),
              }
            );
            continue;
      ...
      function createBlockWithFallback(blockNode) {
        ...
        if (!blockType) {
          ...
          var originalUndelimitedContent = serializeBlockNode(
        ...
        if (!isFallbackBlock) {
          var _getBlockContentValid2 = getBlockContentValidationResult(
              blockType,
              block.attributes,
              innerHTML
            ),
      ...
      function serializeBlockNode(blockNode) {
        ...
        var _options$isCommentDel = options.isCommentDelimited,
          isCommentDelimited =
            _options$isCommentDel === void 0 ? true : _options$isCommentDel;
        var blockName = blockNode.blockName,
          ...
          innerBlocks =
            _blockNode$innerBlock2 === void 0 ? [] : _blockNode$innerBlock2,
          _blockNode$innerConte = blockNode.innerContent,
          innerContent =
            _blockNode$innerConte === void 0 ? [] : _blockNode$innerConte;
        var childIndex = 0;
      ...
      var createParse = function createParse(parseImplementation) {
        return function (content) {
          return parseImplementation(content).reduce(function (
            accumulator,
            blockNode
          ) {
      ...
      function get_raw_transforms_ownKeys(object, enumerableOnly) {
        var keys = Object.keys(object);
        if (Object.getOwnPropertySymbols) {
          var symbols = Object.getOwnPropertySymbols(object);
          if (enumerableOnly)
      ...
      function get_raw_transforms_objectSpread(target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = arguments[i] != null ? arguments[i] : {};
          if (i % 2) {
            get_raw_transforms_ownKeys(Object(source), true).forEach(function (
              key
            ) {
              Object(defineProperty["a" /* default */])(
                target,
            ...
            get_raw_transforms_ownKeys(Object(source)).forEach(function (key) {
              Object.defineProperty(
                target,
                key,
                Object.getOwnPropertyDescriptor(source, key)
      ...
      function getRawTransforms() {
        return Object(external_lodash_["filter"])(getBlockTransforms("from"), {
          ...
          return transform.isMatch
            ? transform
            : get_raw_transforms_objectSpread(
                get_raw_transforms_objectSpread({}, transform),
                {},
                {
      ...
      function shortcode_converter_objectSpread(target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = arguments[i] != null ? arguments[i] : {};
          if (i % 2) {
            shortcode_converter_ownKeys(Object(source), true).forEach(function (
              key
            ) {
              Object(defineProperty["a" /* default */])(
                target,
      ...
      function segmentHTMLToShortcodeBlock(HTML) {
        var lastIndex =
          arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        var excludedBlockNames =
          arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : [];
        // Get all matches.
        var transformsFrom = getBlockTransforms("from");
        var transformation = findTransform(
          transformsFrom,
          function (transform) {
            return (
              ...
              Object(external_lodash_["some"])(
                ...
                function (tag) {
                  return Object(external_wp_shortcode_["regexp"])(tag).test(
                    HTML
                  );
                }
              )
        ...
        var transformTag = Object(external_lodash_["find"])(
          transformTags,
          function (tag) {
        ...
        if (
          ...
          var block = createBlock(
            transformation.blockName,
            getBlockAttributes(
              shortcode_converter_objectSpread(
                shortcode_converter_objectSpread(
                  {},
      ...
      function raw_handling_utils_objectSpread(target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = arguments[i] != null ? arguments[i] : {};
          if (i % 2) {
            raw_handling_utils_ownKeys(Object(source), true).forEach(function (
              key
            ) {
              Object(defineProperty["a" /* default */])(
                target,
      ...
      function getBlockContentSchemaFromTransforms(transforms, context) {
        var phrasingContentSchema = Object(
        ...
        var schemas = transforms.map(function (_ref) {
          ...
          return Object(external_lodash_["mapValues"])(
            ...
            function (value) {
              ...
              return raw_handling_utils_objectSpread(
                raw_handling_utils_objectSpread({}, value),
                {},
                {
                  attributes: attributes,
            ...
            function (objValue, srcValue, key) {
              switch (key) {
                case "children": {
                  ...
                  return raw_handling_utils_objectSpread(
                    raw_handling_utils_objectSpread({}, objValue),
                    srcValue
                  );
                }
                ...
                case "require": {
                  return [].concat(
                    ...
                    Object(toConsumableArray["a" /* default */])(srcValue || [])
                  );
                }
        ...
        var blocks = Object(external_lodash_["compact"])(
          Object(external_lodash_["flatMap"])(pieces, function (piece) {
            ...
            var schema = paste_handler_objectSpread(
              paste_handler_objectSpread({}, blockContentSchema),
        ...
        return Object(external_lodash_["map"])(
          ...
          function (_ref3, index) {
            ...
            if (block && block.name === name) {
              ...
              return templates_objectSpread(
                templates_objectSpread({}, block),
                {},
                {
                  innerBlocks: innerBlocks,
                }
            ...
            var isHTMLAttribute = function isHTMLAttribute(
              attributeDefinition
            ) {
              return (
            ...
            var _convertLegacyBlocks = convertLegacyBlocks(
                name,
