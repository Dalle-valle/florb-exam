    ...
    const callback = (entries, observer)=>{
        entries.forEach((entry)=>{
            ...
            if (entry.intersectionRatio >= 0.5) {
                ...
                if (currentFlorbId === 0) document.querySelector(".florb-index").classList.add("hide");
                else if (document.querySelector(".florb-index").classList.contains("hide")) document.querySelector(".florb-index").classList.remove("hide");
                if (currentFlorbId === sections.length - 1) document.querySelector(".a-down").classList.add("disabled-arrow");
...
},{"regenerator-runtime/runtime":"62Qib"}],"62Qib":[function(require,module,exports) {
/**
