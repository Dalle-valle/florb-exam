...
},{"./utils/matrix.js":"node_modules/gsap/utils/matrix.js"}],"node_modules/micro-api-client/lib/pagination.js":[function(require,module,exports) {
"use strict";
...
},{"micro-api-client":"node_modules/micro-api-client/lib/index.js","./user.js":"node_modules/gotrue-js/lib/user.js"}],"baf.js":[function(require,module,exports) {
"use strict";
...
function saveFlorb() {
  ...
  var str = s.serializeToString(document.querySelector(".face-svg"));
  console.log(document.querySelector("form[name='florb-name']").elements.name.value);
  var test = true;
  var florbName = document.querySelector("form[name='florb-name']").elements.name.value;
  console.log(florbName);

  if (florbName === "") {
    document.querySelector(".error-message").innerHTML = "Name your Florb!";
  } else {
    var createdFlorbs = user.user_metadata.florbs;
    ...
    if (!checkFlorbExists(florbName, createdFlorbs)) {
      ...
      if (user.user_metadata.florbs.length === 0) {
        ...
        user.update({
          data: {
            florbs: [].concat(_toConsumableArray(user.user_metadata.florbs), [newFlorb])
          }
        }).then(function (user) {
          return console.log(user);
        });
...
var faceRect = document.querySelector(".face").getBoundingClientRect();
var colors = document.querySelectorAll(".color");
var face = document.querySelector(".specialface");
var mobileFace = document.querySelector(".mobile-face");
var cx = faceRect.x + faceRect.width / 2;
var cy = faceRect.y + faceRect.height / 2;
var coords = document.querySelector(".trackable");
...
_Draggable.Draggable.create(".drag", {
  ...
  onDragEnd: function onDragEnd() {
    ...
    if (this.hitTest("#face-circle", "50%")) {
      ...
      console.log(document.querySelector("#".concat(this.target.getAttribute("type"))));
      document.querySelector("#".concat(this.target.getAttribute("type"))).appendChild(this.target);
    }
  }
});

function checkFlorbExists(florbName, createdFlorbs) {
  var florbCheck = false;
  createdFlorbs.forEach(function (florb) {
...
try {
  var _loop = function _loop() {
    ...
    function getColor() {
      var currentColor = window.getComputedStyle(color)["background-color"];
...
},{"gsap":"node_modules/gsap/index.js","gsap/Draggable":"node_modules/gsap/Draggable.js","gotrue-js":"node_modules/gotrue-js/lib/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
