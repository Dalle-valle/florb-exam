...
},{"micro-api-client":"node_modules/micro-api-client/lib/index.js","./user.js":"node_modules/gotrue-js/lib/user.js"}],"created-florb.js":[function(require,module,exports) {
"use strict";
...
function setFlorbs() {
  var container = document.querySelector(".created-florbs");
  var florbTemplate = document.querySelector("template");
  var florbArray = user.user_metadata.florbs;
  container.innerHTML = "";

  for (var i = 0; i < florbArray.length; i++) {
    var clone = florbTemplate.cloneNode(true).content;
    clone.querySelector(".created-florb").id = "".concat(i);
...
function deleteFlorb() {
  var florbId = this.parentNode.parentNode.id;
  var florbArray = user.user_metadata.florbs;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","created-florb.js"], null)
//# sourceMappingURL=/created-florb.5ffcdddd.js.map